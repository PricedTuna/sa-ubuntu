...
EOL
    ...
    if [ $? -ne 0 ]; then
        PrintMessage "Error en la configuración de Bind9. Por favor, revisa los archivos de configuración." "error"
        exit 1
    fi
...
EOL
    ...
    PrintMessage "Configuración completada. El servidor DNS está instalado y configurado." "info"
}
